...
<body class="app sidebar-mini">
    ...
    <header class="app-header"><a class="app-header__logo" href="index.html">Vali</a>
        ...
        <a class="app-sidebar__toggle" href="#" data-toggle="sidebar"
            aria-label="Hide Sidebar" id="sidebar"></a>
        <!-- Navbar Right Menu-->
        <ul class="app-nav">
            <li class="app-search">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                        ...
                        class="treeview-indicator fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="{{ route('supplier.list') }}"><i class="icon fa fa-list"></i>Listar</a></li>
                    <li><a class="treeview-item" href="{{route('supplier.create')}}"><i class="icon fa fa-user-plus"></i>Agregar</a>
                    </li>
                </ul>
            </li>
